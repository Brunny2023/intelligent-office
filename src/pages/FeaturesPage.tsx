...
const features = [
  ...
  },
  {
    ...
    headline: "Make Intelligent Office yours.",
          ...
          <div className="container mx-auto px-4 md:px-8 text-center">
            ...
            >
              ...
              <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
                From attendance tracking to executive analytics, Intelligent Office replaces 12+ separate tools with one unified platform designed for African businesses.
              </p>
        ...
        <section className="py-20 md:py-28 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 md:px-8 text-center">
            ...
            <p className="text-primary-foreground/70 max-w-xl mx-auto mb-8">
              Join hundreds of organizations already using Intelligent Office to streamline operations.
            </p>
            <Link to="/signup">
              <Button size="lg" className="bg-accent text-accent-foreground hover:bg-accent/90 font-semibold gap-2">
