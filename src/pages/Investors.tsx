...
const Downloads = [
  ...
  { name: "Strategic Business Plan", status: "queued", phase: "Phase 3" },
  { name: "Three-Year Financial Model (XLSX)", status: "queued", phase: "Phase 3" },
  { name: "Market Research Report", status: "queued", phase: "Phase 4" },
  { name: "Competitive Analysis Report", status: "queued", phase: "Phase 4" },
  { name: "Product Strategy & Technical Architecture", status: "queued", phase: "Phase 4" },
