    ...
    <div className="min-h-screen bg-background">
      <header className="border-b border-border">
        <div className="max-w-4xl mx-auto px-6 py-6 flex items-center justify-between">
          <Link to="/" className="font-display text-xl font-bold text-foreground">Intelligent Office</Link>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Live availability of Intelligent Office platform services, incident history and monthly reliability statistics.
          </p>
          <div className="mt-5">
