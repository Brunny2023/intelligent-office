...
const faqs = [
  ...
  {
    q: "Is Soteria suitable for remote and hybrid teams?",
    a: "Absolutely. Soteria was designed specifically for distributed teams. Daily check-ins, real-time presence tracking, and communication tools ensure your team stays connected regardless of location or timezone.",
  },
  {
  ...
  {
    q: "Can we white-label Soteria for our organization?",
  ...
  {
    q: "What security standards does Soteria meet?",
