...
const faqs = [
  ...
  {
    q: "Is Intelligent Office suitable for remote and hybrid teams?",
    a: "Absolutely. Intelligent Office was designed specifically for distributed teams. Daily check-ins, real-time presence tracking, and communication tools ensure your team stays connected regardless of location or timezone.",
  },
  {
  ...
  {
    q: "Can we white-label Intelligent Office for our organization?",
  ...
  {
    q: "What security standards does Intelligent Office meet?",
